...
def wmrl_m6b_fully_batched_likelihood(
    ...
    *,
    ...
    stimuli, actions, rewards, set_sizes, masks : jnp.ndarray
        Shape (N, B, T).
    alpha, phi, rho, capacity, kappa, kappa_s, epsilon : jnp.ndarray
    ...
    return _over_participants(
        ...
        alpha, phi, rho, capacity, kappa, kappa_s, epsilon,
    )
...
def wmrl_m6b_block_likelihood_pscan(
    ...
    *,
    ...
    alpha, phi, rho, capacity, kappa, kappa_s, epsilon : float
