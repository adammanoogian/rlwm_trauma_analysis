...
#
# Usage:
#   bash cluster/setup_env_gpu.sh           # Fresh install or interactive update
#   bash cluster/setup_env_gpu.sh --update  # Force update existing env (no delete)
#   bash cluster/setup_env_gpu.sh --fresh   # Delete and recreate from scratch
#
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --fresh|-f)
            ...
            ;;
        --help|-h)
            echo "Usage: bash cluster/setup_env_gpu.sh [OPTIONS]"
            echo ""
            echo "Options:"
