...
Usage:
    ...
    python scripts/06_fit_analyses/compare_models.py --use-waic --bayesian-dir output/bayesian_fits

    # Generate winning model predictions
    python scripts/06_fit_analyses/compare_models.py --generate-predictions
...
def run_bayesian_comparison(output_dir: Path) -> None:
    ...
    lines: list[str] = [
        ...
        "",
        "Generated by `scripts/06_fit_analyses/compare_models.py --bayesian-comparison`.",
        "",
        "## LOO Comparison",
        "",
