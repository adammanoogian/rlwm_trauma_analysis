...
from config import FIGURES_DIR, OUTPUT_DIR, DataParams, TaskParams
...
def check_for_deviations(data):
    ...
    deviations = {"errors": [], "warnings": [], "info": []}
...
def main():
    ...
    print("\nNext steps:")
    print(
        "  - Run 02_visualize_task_performance.py to create stimulus-based learning curves"
    )
