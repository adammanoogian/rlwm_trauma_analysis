...
from rlwm.fitting.models.wmrl import wmrl_hierarchical_model
...
def test_wmrl_model_compilation(wmrl_participant_data):
    ...
    prior_samples = numpyro.infer.Predictive(wmrl_hierarchical_model, num_samples=10)(
...
def test_wmrl_prior_ranges(wmrl_participant_data):
    ...
    prior_samples = numpyro.infer.Predictive(wmrl_hierarchical_model, num_samples=100)(
        rng_key, participant_data=participant_data
    )
