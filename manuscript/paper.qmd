...
if _rfx_path.exists():
    ...
    display(pd.DataFrame({
        "Model": ["[Awaiting Bayesian pipeline output]"],
        "PXP": ["—"],
        "EP": ["—"],
...
if _forest_path.exists():
    ...
    print("[Awaiting Bayesian pipeline output — forest plot will be generated on pipeline completion]")
```
...
if _betas_path.exists():
    ...
    display(pd.DataFrame({
        "Parameter": ["[Awaiting Bayesian pipeline output]"],
        "Predictor": ["—"],
        "beta_mean": ["—"],
        "hdi_lo": ["—"],
        "hdi_hi": ["—"],
