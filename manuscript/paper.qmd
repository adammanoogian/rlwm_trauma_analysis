...
from pathlib import Path
import pandas as pd
_loo_primary = Path("../models/bayesian/manuscript/loo_stacking.csv")
_loo_fallback = Path("../models/bayesian/21_baseline/loo_stacking_results.csv")
...
from pathlib import Path
import pandas as pd
_rfx_path = Path("../models/bayesian/manuscript/rfx_bms.csv")
if _rfx_path.exists():
...
from pathlib import Path
import pandas as pd
_betas_path = Path("../models/bayesian/manuscript/winner_betas.csv")
