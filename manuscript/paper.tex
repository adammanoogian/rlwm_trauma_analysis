...
\caption{}\label{T_24efd}\tabularnewline
\toprule\noalign{}
...
reported as M6b: WM-RL+dual (see \textbf{?@tbl-loo-stacking}).
...
\subsection{Participant-Level Winner
...
\subsection{Stratified Model Comparison by Trauma
...
\subsection{Parameter Recovery and
...
\caption{}\label{T_967be}\tabularnewline
\toprule\noalign{}
...
\caption{}\label{T_e68a7}\tabularnewline
\toprule\noalign{}
...
\caption{}\label{T_d3bf1}\tabularnewline
\toprule\noalign{}
...
\caption{}\label{T_9f087}\tabularnewline
\toprule\noalign{}
...
PSIS-LOO stacking is the primary selection criterion. The complete
winner Level-2 beta coefficients with 95\% HDI and FDR-BH flag are
reported in \textbf{?@tbl-winner-betas}; the LOO + stacking ranking is
in \textbf{?@tbl-loo-stacking}; the random-effects BMS PXP is in
\textbf{?@tbl-rfx-bms}; and the winner forest plots are in
\textbf{?@fig-forest-21}. The M6b subscale exploratory arm runs
fire-and-forget --- the resulting subscale beta table may be added via a
post-phase quick task if the arm completes after the main manuscript
build.
...
\caption{}\label{T_1e0ab}\tabularnewline
\toprule\noalign{}
